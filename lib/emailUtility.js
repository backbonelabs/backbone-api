...
/**
 * Sends the user an email, which allows them to confirm that their email address is valid.
 * @param  {String}  email  User email
 * @param  {String}  token  Token used to look up and validate an email confirmation attempt
 * @return {Promise} Rejects on error sending email and resolves with object containing email
