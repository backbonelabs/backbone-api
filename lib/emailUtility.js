...
function sendEmail(data, email, link, resolve, reject) {
...
const sendConfirmationEmail = (email, token) => new Promise((resolve, reject) => {
  ...
  return sendEmail(templates.confirmEmail, email, link, resolve, reject);
});
...
const sendPasswordResetEmail = (email, token) => new Promise((resolve, reject) => {
  ...
  sendEmail(templates.passwordReset, email, link, resolve, reject);
});
